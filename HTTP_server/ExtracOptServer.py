...
app = Flask(__name__)
# URL of the downstream LabVIEW extraction optimization WebService endpoint
URL = 'http://127.0.0.1:8001/AutoExecution_WebService/ExtractionOpt_HTTP'
        ...
        if response_from_target:
            ...
            # If the task has completed, retrieve and encode result images
                ...
                if folder_path:
                    ...
                    response = {"status": "success", "message": "Extraction completed"}
...
# crop_box: (left, top, right, bottom) pixel coordinates; defaults to (600, 100, 1500, 900)
def encode_images_from_folder(folder_path, crop_box=(600, 100, 1500, 900)):
    image_list = []
